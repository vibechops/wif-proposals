# Dell x WIF India - Program brief

Updated after Rabia intake (Jun 2026). Lead via **EMG** (London brand placement agency; Julia + Adam pitching for Dell).

## Post-intake: what is confirmed

| Item | Status |
|---|---|
| End client | **Dell** (via EMG) |
| Agency | **EMG** (London); contacts Julia + Adam |
| Programs in scope | **3:** Screenwriters Residency Lab, Internship Program, Exhibition Program |
| Proposal format | **Consolidated custom proposal** for Dell; WIF charter sent separately for broader menu |
| In-film branding | **Parallel interest**; Rabia connecting Dell to Sikhya / Raunaq (not costed as a WIF program here) |
...
| Program | Location |
|---|---|
| Screenwriters Lab | Residential: Kolkata / Darjeeling; pan-India applications |
| Internship | Nationwide placements across production houses, OTT, channels |
| Exhibition | PVR cinemas (multi-city); premiere events in key metros |

## Content / eligibility rules

**Screenwriters Lab:**
- Open to Indian citizens; original fiction feature film ideas only
- Any Indian language (English translation if required)
- Genre specified; SWA or regional registration mandatory
- IP stays with the writer
...
- Awareness and exposure over glamour; toned-down red carpet format

## Budget summary (internal INR)
...
| Venues + production | No | Yes (lab, premieres, closing ceremonies) |
...
```
dell/
  00-intake/rabia-notes.md
  00-intake/WIF India Screenwriters Lab-3.pdf
  00-intake/Screenwriters lab - BUDGET - Sheet1-3.pdf
  00-intake/Proposal for Kamla Mills Foundation - Internal .docx
  01-brief/project.md              <- this file
  04-specs/program-flow.md
  04-specs/event-spec.md
  03-budget/budget-outlook.md
  03-budget/cost-breakdown.md
  03-budget/pricing-recommendation.md
  02-deck/deck-outline.md
  02-deck/a4-pdf-outline.md
  05-research/
  06-deliverables/
```
...
- Mentor confirmations for Screenwriters Lab roster
- Festival tie-up partner for Lab Part 2 (TIFF India / Film Bazaar style)
