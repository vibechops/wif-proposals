...
| **Premiere Program** | Marquee industry premieres for 6 women-led films (1 premiere per film) | **USD $150,000** |
...
| Outcome | Lab | Premiere | Internship |
|---|---|---|---|
| Feature scripts developed | 6 | - | - |
| Mentors engaged | 6 | - | - |
| Films premiered | - | 6 | - |
| Marquee premieres (total) | - | 6 | - |
...
- Dell logo on applications, event collateral, premiere materials, certificates
...
**In-film branding** (product placement) is a separate track via Sikhya / Raonaq. WIF facilitates the introduction.
...
Optional follow-on years at the same rate. Lab and Premiere are one-time or annual programs priced independently.

---

## Internal cost reference (not client-facing)

| Program | Internal cost (INR) | USD equivalent |
|---|---:|---:|
| Screenwriters Lab (one-time, 3-day) | ₹1.10 Cr | ~$130K |
| Premiere (annual, draft) | ₹75 L | ~$88K |
| Internship (annual) | ₹2.5 Cr | ~$294K |

Detail and margin analysis: `cost-breakdown.md`
...
| Milestone | % | Lab | Premiere | Internship |
|---|---:|---:|---:|---:|
...
- Premiere Program budget is based on draft assumptions (6 films, 6 marquee premieres). Final numbers after Rabia confirmation.
