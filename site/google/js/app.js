(function () {
  ...
  function runner(page) {
    return `
      <header class="runner">
        ...
        <span class="runner__brand">Google&nbsp;Flow &times; WIF&nbsp;India</span>
      </header>`;
  }
        ...
        <div class="cover-frame">
          ...
          <div class="cover-hero">
            ...
            <div class="cover-lockup">
              <img src="assets/google-logo.png?v=1" alt="Google" class="cover-google">
              <span class="cover-flow">Flow</span>
          ...
          <footer class="cover-foot">
            ...
            <span class="cover-meta">7 cities &middot; 16 weeks</span>
          </footer>
        </div>
      </article>`;
  }
  ...
  function renderStatement(p) {
    ...
    const cards = d.cards
      ...
      .join("");
    const inner = `
      ${titleblock(KICKERS.statement, d.heading)}
  ...
  function renderBullets(p) {
    ...
    const items = d.items
      ...
      .join("");
    const inner = `
      ${titleblock(KICKERS.bullets, d.heading)}
  ...
  function renderSections(p) {
    ...
    const blocks = d.sections
      ...
      .join("");
    const inner = `
      ${titleblock(KICKERS.sections, d.heading)}
  ...
  function renderBudget(p) {
    ...
    const tiers = d.tiers
      ...
      .join("");
    const inner = `
      ${titleblock(KICKERS.budget, d.heading)}
      <div class="budget">
  ...
  function renderAsk(p) {
    ...
    const asks = d.ask
      ...
      .join("");
    const inner = `
      ${titleblock(KICKERS.ask, d.heading)}
      <p class="ask-lead">${d.lead}</p>
      <div class="ask-grid">
        <div class="ask-col">
          <p class="ask-col__label">What we ask of Google</p>
  ...
  function updateUI() {
    ...
    document.title = `${p.title} | Google Flow × WIF India`;
  }
